...
<head>
	...
	$idobra=$_GET['id']; //php para capturar el parámetro pasado por URL
	include('./php/actualiza_datos_sigos.php');
	?>
	...
	<link rel="stylesheet" type="text/css" href="./css/geoext-all.css"/>
	...
	<script type="text/javascript" src="editToolbar.js"></script>
