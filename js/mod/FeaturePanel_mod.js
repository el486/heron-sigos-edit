...
//	}),
	...
	/** private: createBuffer(features,distance,layer)
	 * Add buffer features from toolbar.
     */
    createBuffer: function (features,distance,layer) { 
		  var input,buffer,feature1/*,feature2*/;
		  ...
		  for(var feat in features) {
			...
			try{
				...
				//layer.addFeatures([feature2]);
					...
					if (e!="TypeError: Cannot read property 'toString' of undefined"){
					sinProc=sinProc+1;
					//errTxt += "Feature: Geometry: "+ geoString +",";
					for (var j in features[feat].attributes) {
						errTxt += j+":"+features[feat].attributes[j]+"\n"; 
					}						
					errTxt +=e+"\n\n";
					}
				} 			
